...
app.post("/create-checkout-session", async (req, res) => {
  ...
  try {
    const payload = {
      ...
      line_items: items,
      // success_url: process.env.VUE_APP_CT_API_URL + "/confirm?checkout_session={CHECKOUT_SESSION_ID}",
...
//   const ctCustomerId = req.body.customer;
//   // console.log(ctCustomerId,"cus");
//   const ctCustomer = await commerceTools.getCustomer(ctCustomerId);
//   // console.log(ctCustomer,"ctcus");
//   const currency = req.body.currency;
...
//       //   },
//       // },
//       productId:item.productId.value.productId,
//       quantity: 1,
//     });
...
//       // line_items: [
//       //   {
//       //     price: "price_1NLL3SSFzaytGXRXflLOJhCE",
//       //     quantity: 2,
//       //   },
//       // ],
//       success_url:   "http://localhost:8080/DE/en/?checkout_session={CHECKOUT_SESSION_ID}",
//       cancel_url: "http://localhost:8080/DE/en",
//       // metadata: { summary: summary },
//       // payment_intent_data:{
//       //   metadata:{
//       //     summary: summary,
