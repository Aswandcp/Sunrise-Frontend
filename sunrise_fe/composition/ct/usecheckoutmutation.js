...
export const createCheckoutSession = async (
  ...
  customer,
    ...
    .mutate({
      mutation: gql`
      mutation CreateCheckoutSession($cart: String!, $customer: String!, $currency: String!) {
        createCheckoutSession(cart: $cart, customer: $customer, currency: $currency) {
          sessionId
          url
        }
      }
...
// const usecheckoutmutation = ({ cart,customer,currency }) => {
//   const [mutateFunction, { data, loading, error }] =
//     useMutation(mutation);
//   const [createCart] = useMutation(create);
//   const { cart, exist } = useCart();
//   const mutateCheckout = (actions) => {
